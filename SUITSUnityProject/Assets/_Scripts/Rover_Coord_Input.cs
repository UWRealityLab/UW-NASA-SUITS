...
public class Rover_Coord_Input : MonoBehaviour
{
    ...
    public void SendRover()
    {
       
        RoverManager.Instance.SendRover(new Vector2(float.Parse(_latitudeInput.text), float.Parse(_longitudeInput.text)));
    }
